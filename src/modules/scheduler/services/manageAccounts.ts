...
export class AccountSchedulerService {
    ...
    //every Midnight - DISABLED to prevent accidental data loss
    // Auto-delete disabled on 2025-12-19 to allow user recovery
    // Users can now re-register with same email if account was deleted
