...
export class BankDetailResponseDto {
  @ApiProperty({ description: 'Unique identifier of the bank detail', example: 1 })
  @IsNumber()
  @Type(() => Number)
  id: number;

  @ApiProperty({ description: 'ID of the user this bank detail belongs to', example: 1 })
  @IsNumber()
  @Type(() => Number)
  userId: number;
  ...
  @ApiProperty({ description: 'Creation date of the bank detail', example: '2023-01-01T00:00:00Z' })
  @Type(() => Date)
  createdAt: Date;

  @ApiProperty({ description: 'Last updated date of the bank detail', example: '2023-01-01T00:00:00Z' })
  @Type(() => Date)
  updatedAt: Date;
}