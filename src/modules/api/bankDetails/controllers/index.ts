import { Controller, Post, Get, Patch, Delete, Body, Param, UseGuards, HttpStatus, Req } from '@nestjs/common';
...
export class BankDetailsController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a bank detail for the user specified by the ID in the path.',
  })
  @ApiParam({
    name: 'id',
  ...
  async create(@Param('id') id: string, @Body() createBankDetailDto: CreateBankDetailDto) {
    return this.bankDetailsService.create(parseInt(id), createBankDetailDto);
  }
  ...
  async update(
    ...
    return this.bankDetailsService.update(req.user.id, parseInt(id), updateBankDetailDto);
  }
